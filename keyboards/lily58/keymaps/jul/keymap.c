...
#define COLORBACK 170, 255, 255
#define COLORSURB 0, 255, 255
#define COLORSURB2 51, 87, 100
/*
    {0,20, COLORBACK},// Light 20 LEDs, starting with LED 0
    {20,1, COLORSURB},
    {21,5, COLORBACK},
    {26,3, COLORSURB},
    {29,6, COLORBACK},
    ...
    {68,2, COLORBACK}
*/
    {0,70, COLORBACK},// Light 20 LEDs, starting with LED 0
    {20,1, COLORSURB},
    {26,3, COLORSURB},
    {50,6, COLORSURB},
    {62,3, COLORSURB},
...
void change_keyboard_color_for_layer(void){
      ...
      switch (get_highest_layer(layer_state)) {
        ...
        case _RAISE:
            ...
            rgblight_sethsv_at(HSV_RED, 20);
            rgblight_sethsv_range(HSV_RED, 26,29);
            break;
        case _ADJUST:
