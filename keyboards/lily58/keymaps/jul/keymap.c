...
[_RAISE] = LAYOUT(
  ...
  KC_TRNS,  KC_SLCK, KC_HOME,  KC_END,  KC_INS, KC_NO,                     KC_P7,   KC_P8,   KC_P9,   KC_PPLS, KC_PMNS, KC_F12,
  KC_TRNS,  KC_PAUS, KC_PGUP, KC_UP,   KC_PGDN, KC_NO,                    KC_P4,   KC_P5,   KC_P6,   KC_PAST, KC_PSLS, TO(3),
  KC_TRNS,  KC_PSCR, KC_LEFT, KC_DOWN, KC_RGHT, KC_NO, KC_CAPS, KC_NLCK,  KC_P1,   KC_P2,   KC_P3,   KC_PEQL, KC_NO, KC_TRNS,
